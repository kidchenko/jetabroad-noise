...
namespace JetabroadNoise.Cli.Test.Unit.Image
{
    public class MotherNatureTest
    {
        ...
        {
            var biome = new MotherNature().Create(0.06, 0);
        ...
        {
            var biome = new MotherNature().Create(0.08, 0);
		...
		{
			var biome = new MotherNature().Create(0.12, 0);
		...
		{
			var biome = new MotherNature().Create(0.77, 0);
		...
		{
			var biome = new MotherNature().Create(0.55, 0);
		...
		{
			var biome = new MotherNature().Create(0.44, 0);
		...
		{
			var biome = new MotherNature().Create(0.27, 0);
